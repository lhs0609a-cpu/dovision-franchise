...
const fallbackFAQs = [
  ...
  { id: "2", question: "초기 투자비는 얼마나 드나요?", answer: "30~35평 기준 총 1억원입니다. 가입비 1,000만원 · 인테리어 2,500~3,000만원 · 강의시설/장비 1,500만원 · 교육비(3개월) 1,500만원. 임대보증금 2,500~3,000만원은 별도이며, 월 운영비는 1,300~1,800만원(본사 공급원가 22.5% 포함)입니다.", category: "investment" },
  { id: "3", question: "손익분기점(BEP)은 언제 도달하나요?", answer: "월 신규등록 3~4명이 BEP 지점입니다(월 지출 1,800만원 · 본사 공급원가 22.5% 포함, 6개월 선불 480만원 기준). 5명 시 월 순이익 600만원, 7명 시 1,560만원, 10명 시 3,000만원 구간에 진입합니다.", category: "investment" },
  { id: "4", question: "본사에 지급하는 비용(로열티·앱교재비)은 얼마인가요?", answer: "본사 공급원가는 매출액의 22.5%입니다 — 매출 연동 로열티 10%(신규 프로그램·교재 업데이트, 슈퍼바이저 방문 컨설팅 포함, 하한선 월 250만원) + 앱 교재비 12.5%(회원 1인 6개월 60만원, 학습앱·디지털 교재 라이선스). 음식점의 재료비에 해당하며, 매출의 77.5%가 가맹점주에게 남습니다.", category: "investment" },
  ...
  { id: "9", question: "상담은 어떻게 신청하나요?", answer: "홈페이지 상담 신청 폼, 전화(0507-1434-3226), 카카오톡 1:1 상담 등 다양한 채널로 신청 가능합니다. 접수 후 1영업일 이내에 연락드립니다.", category: "general" },
];
